package com.streamhemaprime.hemaprime.network;
...
public class APIConstants {
    ...
    static class URLs {
        static final String LIVE_URL = "https://admin.hemaprime.com/";
        static final String STAGING_URL = "http://admin-hemaprime.botfingers.com/";
    ...
    public static class STATIC_PAGES {
        ...
        public static final String ABOUT_URL = "https://hemaprime.com/#/page/1";
        public static final String TERMS_URL = "https://hemaprime.com/#/page/4";
        public static final String HELP_URL = "https://hemaprime.com/#/page/5";
        public static final String SPEED_TEST_URL = "https://fast.com";
        public static final String PRIVACY_URL = "https://hemaprime.com/#/page/3";
    }
