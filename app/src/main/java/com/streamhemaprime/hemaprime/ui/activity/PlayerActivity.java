...
public abstract class PlayerActivity extends BaseActivity implements PlayerListener {
    ...
    private void onTimedText(GiraffePlayer giraffePlayer, IjkTimedText text) {
